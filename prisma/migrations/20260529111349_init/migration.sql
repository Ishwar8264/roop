...
-- CreateEnum
CREATE TYPE "AuthEventType" AS ENUM ('LOGIN_SUCCESS', 'LOGIN_FAILED', 'OTP_SENT', 'OTP_VERIFIED', 'LOGOUT', 'TOKEN_REFRESHED');
...
-- AddForeignKey
ALTER TABLE "auth_otps" ADD CONSTRAINT "auth_otps_mobile_fkey" FOREIGN KEY ("mobile") REFERENCES "users"("mobile") ON DELETE CASCADE ON UPDATE CASCADE;

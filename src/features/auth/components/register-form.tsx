 ...
 *   - Clean input fields with left icons and floating labels
 *   - Password fields with visibility toggle + strength hint
 *   - Gradient rose-pink primary buttons
 *   - Step indicator for 2-step flow
 *   - Details summary in OTP step
 */

"use client";

import { Phone, User, Mail, AtSign, CheckCircle2, Shield } from "lucide-react";
      ...
      {form.step === "details" && (
        <form onSubmit={form.detailsForm.handleSubmit(form.handleSendOtp)} className="space-y-4">
          ...
          <FloatingLabelInput
            ...
            error={form.detailsForm.formState.errors.username?.message}
            registerProps={form.detailsForm.register("username")}
          />
          ...
          <FloatingLabelInput
            ...
            error={form.detailsForm.formState.errors.email?.message}
            registerProps={form.detailsForm.register("email")}
          />
          ...
          <div>
            <PasswordInput
              ...
              error={form.detailsForm.formState.errors.password?.message}
              registerProps={form.detailsForm.register("password")}
            />
          ...
          <PasswordInput
            ...
            error={form.detailsForm.formState.errors.confirmPassword?.message}
            registerProps={form.detailsForm.register("confirmPassword")}
          />
      ...
      {form.step === "otp" && (
        <form onSubmit={form.otpForm.handleSubmit(form.handleVerifyOtp)} className="space-y-5">
          <DetailsSummary
            ...
            onChangeDetails={form.handleChangeDetails}
            t={t}
          />
          <OtpInput
